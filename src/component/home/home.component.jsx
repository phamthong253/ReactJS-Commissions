      ...
      <div className="-z-10 bg-gradient-to-r from-indigo-200 via-purple-200 to-sky-200">
        <div className="max-w-full">
          ...
          <div className="text-center w-full md:px-60 md:my-32 my-12 py-12 max-w-screen-2xl justify-around">
            ...
            {auth ? (
              <Link to={"/create"}>
                <button className="rounded-2xl font-black text-center text-xl bg-violet-500 border-2 border-black h-14 min-w-[15rem] text-white leading-10">
                  Let&apos;s get started
                </button>
              </Link>
            ) : (
              <Link to={"/signup"}>
                <button className="rounded-2xl text-center text-xl bg-violet-500 border-2 border-black h-14 min-w-[15rem] text-white font-black leading-10">
                  Let&apos;s get started
                </button>
              </Link>
            )}
          ...
          <div className="mb-32 max-w-full lg:px-40 px-14 grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Link to={"/artist"}>
              <div className="flex justify-center mx-auto">
                <button className="rounded-2xl text-center font-black text-xl bg-violet-500 border-2 border-black h-14 min-w-[15rem] text-white leading-10">
                  Choose your Artist
                </button>
              </div>
            </Link>
                ...
                <div className="flex flex-wrap items-center">
                  ...
                  <div className="grow-0 shrink-0 basis-auto w-full lg:w-6/12 xl:w-8/12">
                    <div className="px-6 py-12 md:px-12">
                      ...
                      <Link to={"/artist"}>
                        <button className="rounded-2xl my-5 text-center text-xl bg-violet-500 border-2 border-black h-14 min-w-[10rem] text-white font-black leading-10">
                          Show more
                        </button>
                      </Link>
                    </div>
